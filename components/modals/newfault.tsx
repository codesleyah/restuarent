...
const NewFault = ({onClose}: ModalProps) => {
    ...
    let images = ["/images/main.jpg","/images/main1.jpg","/images/main2.jpg","/images/main3.jpg",  ]
    return (
            ...
            <div className="bg-white shadow rounded w-1/2 h-full flex flex-col p-4 gap-4">
                ...
                <div className="flex flex-col gap-4 p-4 h-full items-center justify-center">
                    ...
                    <div className='flex flex-row justify-between p-4 w-full'>
                        <button  className="bg-red-900 text-white p-2 rounded" onClick={()=>{counter > 1 ? setCounter(counter-1): null}}>
                            Prev
                        </button> 
